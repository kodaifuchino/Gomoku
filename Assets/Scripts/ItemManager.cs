...
public class ItemManager : MonoBehaviour
{
    ...
    public bool blackhole = false;//BlackHole: 次に選択したマスに自分の碁石を置きその周囲のマスをすべて消滅させる。消滅したマスに既に置かれていた石は不可視化されるが、効果は残る。つまり消滅する前の石の場所を記憶する必要がある。また不可視化された石はZeroGravityやMeteorの影響を受ける。
